...
Yes (v1.0.72+). Multi-turn subagents are always enabled — you can send follow-up messages to a subagent that is still running, allowing you to steer its work mid-task without waiting for it to complete.
