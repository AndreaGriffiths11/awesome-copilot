...
If you have GitHub Copilot CLI installed, you can open the Copilot app in the current directory with a single command (v1.0.81+):

```bash
copilot app
```

This launches the Copilot app scoped to the current repository — handy when you're already in a terminal and want to spin up the graphical interface without leaving your shell or navigating through the app manually.
