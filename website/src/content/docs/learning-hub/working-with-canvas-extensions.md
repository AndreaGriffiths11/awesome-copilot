...
> **New in v1.0.71**: Canvas support is now available in **GitHub Copilot CLI** in addition to the Copilot app, allowing extension-driven canvas interactions directly from your terminal.
