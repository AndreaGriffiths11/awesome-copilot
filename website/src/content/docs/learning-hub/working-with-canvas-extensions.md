...
> **CLI support (v1.0.71+)**: Canvas extensions are now available in the Copilot CLI, not just the Copilot app. Extension-driven canvas interactions work in interactive CLI sessions, letting you build and use canvases from your terminal workflow.
